    ...
    <div className="flex items-center p-4 bg-gray-50 rounded-xl mb-3 border border-gray-100 group">
      ...
      <div className="flex items-center gap-3 bg-white px-2 py-1.5 rounded-lg border border-gray-200 shadow-sm min-w-max mr-3 shrink-0">
        <button 
          ...
          className="w-7 h-7 flex items-center justify-center font-bold text-blue-600 hover:bg-blue-50 rounded-full transition-colors"
        >
          −
        </button>
        ...
        <button 
          ...
          className="w-7 h-7 flex items-center justify-center font-bold text-blue-600 hover:bg-blue-50 rounded-full transition-colors disabled:text-gray-300"
        >
          +
        </button>
      </div>
